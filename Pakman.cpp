...
//Параметры карты (высота и шиирна)
const int H = 21;
const int W = 19;

const int ts = 25;

//Коэффициент выиграша и жизни
int q = 0;
bool life = true;
...
//Передвижение и взаимодействие игрока
    void update() {
...
int main() {
    srand(time(0));
    RenderWindow window(VideoMode(W * ts, H * ts), "Labirinth!");

    Texture t;
    t.loadFromFile("C:/Users/Gilyana/Desktop/Paint/mitle.png");
    Sprite plat(t);

    Texture yw;
    yw.loadFromFile("C:/Users/Gilyana/Desktop/Paint/youwin.png");
    Sprite youwin(yw);
    youwin.setPosition(100, 210);

    Texture yl;
    yl.loadFromFile("C:/Users/Gilyana/Desktop/Paint/youlose.png");
    Sprite youlose(yl);
